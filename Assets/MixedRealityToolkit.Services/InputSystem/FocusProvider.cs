...
namespace Microsoft.MixedReality.Toolkit.Input
{
    ...
    public class FocusProvider : BaseDataProvider, IMixedRealityFocusProvider
    {
        ...
        private class PointerData : IPointerResult, IEquatable<PointerData>
        {
            ...
            {
                Pointer = pointer;
                focusDetails.SessionConfiguration = new FocusSessionConfiguration();
            }
            ...
            public void UpdateHit(PointerHitResult hitResult)
            {
                if (hitResult.hitObject != CurrentPointerTarget)
                {
                    ...
                    // Set to default:
                    focusDetails.SessionConfiguration.IsTargetPositionLockedOnFocusLock = true; 
                }
        ...
        private void UpdatePointer(PointerData pointer)
        {
            ...
            else
            {
                ...
                if (pointer.Pointer.IsFocusLocked && pointer.Details.SessionConfiguration?.IsTargetPositionLockedOnFocusLock == true)
                {
