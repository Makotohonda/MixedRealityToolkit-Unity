...
public class HandInteractionPan : BaseFocusHandler, IMixedRealityTouchHandler, IMixedRealityPointerHandler
{
    ...
    private void ValidityCheck()
    {
        ...
        {
            mesh = null;
            Debug.Log($"The GameObject: '{gameObject.name}' does not have a Mesh component.");
        }
        else
        {
    ...
    void IMixedRealityPointerHandler.OnPointerDown(MixedRealityPointerEventData eventData)
    {
        if (touchType == TouchType.HandRay)
        {
            if (currentPointer == null)
            {
                ...
                currentPointer.Result.Details.SessionConfiguration.IsTargetPositionLockedOnFocusLock = false;
